package com.zicms.common.poi.common;

import com.zicms.common.poi.bean.ExcelConfig;
import com.zicms.common.poi.bean.Field;
import com.zicms.common.poi.generater.GenXml;
import jxl.*;
...
public class XlsUtil {
     ...
     * @throws Exception
     */
    public static List<?> xls2List(ExcelConfig config, InputStream is) throws Exception {
        Workbook wb = null;
        List<?> list = null;
        try {
