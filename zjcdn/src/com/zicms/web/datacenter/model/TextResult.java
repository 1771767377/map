...
public class TextResult extends BaseEntity {
    ...
    private Integer trialStatus;// 初审状态

    private Integer retrialStatus;// 复审状态

    private Integer exportStatus;// 导出状态
    ...
    public Integer getRetrialStatus() {
        return this.getInteger("retrialStatus");
    }

    public void setRetrialStatus(Integer retrialStatus) {
