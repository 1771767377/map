...
import com.zicms.web.sys.mapper.SysAreaMapper;
...
public class SysDictService extends ServiceMybatis<SysDict> {
	...
	* @return
	...
	public String getValue(String type,String label){
		List<SysDict> sysdicts = (List<SysDict>) findAllMultimap().get(type);
	...
	public PageInfo<SysDict> findPageInfo(Map<String, Object> params) {
		...
		List<SysDict> list = sysDictMapper.findPageInfo(params);
