...
import com.zicms.common.base.BaseController;
...
public class RoleController extends BaseController {
    ...
    public @ResponseBody
    List<SysUser> officeUser(Long officeId) {
    ...
    public @ResponseBody
    Integer saveUserRole(@ModelAttribute SysRole sysRole) {
    ...
    public @ResponseBody
    Integer save(@ModelAttribute SysRole sysRole) {
